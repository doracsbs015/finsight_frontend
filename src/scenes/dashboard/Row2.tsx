...
import { grey, blue, green } from "@mui/material/colors"; // added colors
...
const Row2 = () => {
  useTheme();
  const pieColors = [blue[800], blue[300]]; // replace palette numeric
      ...
      <DashboardBox gridArea="e">
        ...
        <FlexBetween mt="0.25rem" gap="1.5rem" pr="1rem">
          ...
          <Box ml="-0.7rem" flexBasis="40%" textAlign="center">
            ...
            <Typography m="0.3rem 0" variant="h3" color={blue[300]}>
              83
            </Typography>
